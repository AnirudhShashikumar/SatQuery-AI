...
export type AgentHealth = {
  ...
  router: string;
  registry: string;
  specialists: Record<string, { status: string; device: string | null; error: string | null }>;
};
...
export type AgentResponse = {
  ...
  answer: string | null;
  confidence: { level: ConfidenceLevel; score: number | null; reason: string };
  evidence: Array<{ type: string; label: string; description?: string | null; reference?: string | null }>;
  execution: {
    input_mode: InputMode;
    selected_tools: string[];
...
export type QuestionCategory =
  ...
  | "change_region_count" | "change_magnitude" | "cross_modal_agreement" | "cross_modal_water"
