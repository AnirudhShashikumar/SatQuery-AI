...
export const modelCatalog = {
  ...
  "change-detection": {
    ...
    summary: "Combines the local ChangerEx learned binary change detector with an independent deterministic analyzer. The learned mask is primary when ChangerEx is ready; deterministic evidence remains available for comparison and fallback.",
    integration: "Bi-temporal Assistant workflow",
    checkpoint: "ChangerEx_r18-512x512_40k_levircd_20221223_120511.pth · fingerprint disclosed at runtime",
    ...
    provenance: "Pure-PyTorch ChangerEx + IA-ResNetV1c-18 · LEVIR-CD; deterministic normalized-difference analyzer",
    limitations: ["ChangerEx is trained primarily on optical building-change imagery from LEVIR-CD.", "Outputs are binary change predictions, not ground truth.", "The workflow does not infer the semantic cause of change."],
    actionHref: "/assistant?mode=bi_temporal",
    actionLabel: "Run Bi-temporal Analysis",
    specialistHealthKey: "changerex_change_detector",
    supportingStack: ["ChangerEx learned change detector", "Deterministic normalized-difference analyzer", "Explicit hybrid agreement and fallback"],
  },
  "color-corrector": {
